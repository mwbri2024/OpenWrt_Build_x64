...
# 修改默认IP
sed -i 's/10.10.1.222/10.110.18.1/g' package/base-files/files/bin/config_generate
sed -i 's/10.10.1.222/10.110.18.1/g' package/base-files/luci2/bin/config_generate
